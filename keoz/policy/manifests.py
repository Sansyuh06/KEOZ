...
class ManifestGenerator:
    ...
    def generate_openapi_spec(policy: MerchantPolicy, base_url: str = "http://localhost:8000") -> Dict[str, Any]:
        ...
        return {
            "openapi": "3.1.0",
            "info": {
                "title": f"{policy.merchant} Agentic Commerce API (KEOZ)",
                "version": policy.version,
                "description": "KEOZ-governed endpoint for autonomous buyer agents"
            },
...
# Aliases
ACPManifestGenerator = ManifestGenerator
X402ConfigGenerator = ManifestGenerator
